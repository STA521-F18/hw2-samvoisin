...
PreTMod %>%
  filter(row.names(.) == "China" |row.names(.) == "India") %>%
  cooks.distance()
...
boxTidwell(ModernC ~ PPgdp + Pop + Fertility, data = UN3_rmna)
boxTidwell(ModernC ~ PPgdp + Pop + Purban, data = UN3_rmna)
boxTidwell(ModernC ~ Pop + Purban + Fertility, data = UN3_rmna)
# placeholder for Frate
boxTidwell(y = UN3_rmna$ModernC, x1 = UN3_rmna$Pop)
boxTidwell(y = UN3_rmna$ModernC, x1 = UN3_rmna$Fertility)
