...
ModcFemR <- ggplot(data = UN3_rmna, aes(x = Purban, y = ModernC)) + 
  geom_point(size = 2.5) +
  geom_smooth(color = "red", se = FALSE) +
  ggtitle("% of Females in Economy vs Modern Contraception %") +
...
#boxTidwell(ModernC ~ Frate,
#           other.x = log(Pop),
#           data = UN3_rmna)

boxTidwell(ModernC ~ PPgdp + Pop + Fertility,
           other.x = ~ Change + Frate,
           data = UN3_rmna)

PostXTMod <- lm(ModernC ~ Change + PPgdp +
                  Frate + log(Pop) +
                  Fertility,
                data = UN3_rmna)
...
ggplot(data = UN3_rmna, aes(x = log(Pop), y = ModernC)) + 
  geom_point(size = 2.5) +
  ggtitle("Population vs Modern Contraception %") +
...
ggplot(data = UN3_rmna, aes(x = Fertility, y = ModernC)) + 
  geom_point(size = 2.5) +
  geom_smooth(color = "red", se = FALSE) +
